                ...
                {listTask && listTask.length > 0 ?
                    <div className='card-todo'>
                        ...
                        <div>
                            ...
                            {!isShow ? <Pagination showSizeChanger={false} total={totalPage} pageSize={5} onChange={handleChangePage} defaultCurrent={1} style={{ display: 'flex', justifyContent: 'center', marginTop: '20px' }} /> : null}
